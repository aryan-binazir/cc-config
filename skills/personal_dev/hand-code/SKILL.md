...
- **Topic** (`Result in Rust`): the smallest project that runs at `~/repos/_scratch/<topic>`: one feature, one file, one test that passes only once I've used it properly. Tests are yours unless I say "tests too".
