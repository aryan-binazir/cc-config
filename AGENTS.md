...
# Workflow
- For implementation work, spawn a collaboration sub-agent and delegate the implementation to it. Do not invoke the `implementer` skill or run `delegate.py` for this instruction.
