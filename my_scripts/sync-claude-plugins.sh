...
# into Codex (~/.codex/skills/) and OpenCode (~/.config/opencode/skills/).
#
...
# Won't create ~/.codex/ or ~/.config/opencode/ if they don't exist.
# Requires: jq, rsync
...
# --- Helper: get target skills dir for a tool ---
