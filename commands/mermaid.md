...
**Output location**: `_scratch/diagrams/<name>.<ext>`
...
`_scratch/diagrams/branch-oauth-refresh-dataflow.html`:
...
`_scratch/diagrams/branch-oauth-refresh-dataflow.md`:
...
`_scratch/diagrams/system-auth-flow.html`:
