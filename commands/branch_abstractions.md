...
- Store in `_scratch/` directory (create if needed).
- Filename: `_scratch/{branch}-abstracts.md` where `{branch}` is the current git branch name.
...
```
Abstractions artifact: _scratch/{branch}-abstracts.md
